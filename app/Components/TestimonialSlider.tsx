...
const TestimonialSlider = () => {
    return (
        ...
        >
            ...
            <ClientReview image="/images/c2.jpg" name="Fahad Iqbal" role="AI Specilist" body="As an AI Specialist, Ahmad has been invaluable to our project. His deep understanding of machine learning algorithms and artificial intelligence has significantly enhanced the functionality of our application." rating={4} />

        ...
        <div className="pt-[4rem] md:pt-[8rem] pb-[5rem] bg-[#09101a]">
            ...
            <div className="w-[80%] mx-auto pt-[4rem] md:pt-[8rem] grid grid-cols-l md:grid-cols-2 gap-[2rem] items-center">
                <div>
                    ...
                    <SkillsLanguage skill1="Flutter/Dart" skill2="Html/Css" skill3="Next JS/TypeScript" level1="w-[95%]" level2="w-[90%]" level3="w-[90%]" />
                </div>
                <div>
                    ...
                    <SkillsItem title="AI Specialist" year="2024 - 2024" body="I specialize in artificial intelligence, with expertise in developing ML models for various applications." />
